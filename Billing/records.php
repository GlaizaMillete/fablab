    ...
    <div class="container">
        ...
        <div id="billingModal" class="modal">
            <div class="modal-content">
                ...
                <h2>Billing Form</h2>
                <form id="billingForm" enctype="multipart/form-data">
                    <div>
            ...
            <form method="GET" class="filter-grid">
                ...
                <div>
                    ...
                    <select name="equipment">
                        ...
                        <option value="Vinly Cutter" <?= isset($_GET['equipment']) && $_GET['equipment'] == 'Vinly Cutter' ? 'selected' : '' ?>>Vinly Cutter</option>
                        <option value="Embriodert Machine1" <?= isset($_GET['equipment']) && $_GET['equipment'] == 'Embriodert Machine1' ? 'selected' : '' ?>>Embriodert Machine(One Head)</option>
                        <option value="Embriodert Machine4" <?= isset($_GET['equipment']) && $_GET['equipment'] == 'Embriodert Machine4' ? 'selected' : '' ?>>Embriodert Machine(Four Heads)</option>
                        <option value="Faltbed Cutter" <?= isset($_GET['equipment']) && $_GET['equipment'] == 'Faltbed Cutter' ? 'selected' : '' ?>>Faltbed Cutter</option>
        ...
        document.getElementById("billingForm").addEventListener("submit", function(e) {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    // Format date
                    const formattedDate = new Date(data.billing_date).toLocaleDateString('en-US', {
                        year: 'numeric',
                        month: 'long',
                        day: 'numeric'
                    });
                    ...
                    tooltip: {
                        callbacks: {
                            label: function(context) {
                                return context.label + ': ₱' + context.raw.toLocaleString('en-PH', {minimumFractionDigits: 2});
                            }
                        },
                        bodyFont: {
                            size: 15
